...
from alpespartners.modulos.programas.dominio.objetos_valor import TipoPrograma, Marca, EstadoPrograma, VentanaAtribucion, PoliticasCumplimientoAntiFraude
...
class MapeadorPrograma(RepMap):
    ...
    def entidad_a_dto(self, entidad: Programa) -> ProgramaDTO:
        return ProgramaDTO(
            ...
            marca_anunciante_id=str(entidad.marca_anunciante.id),
